...
namespace GDAXClient.Specs.Services.Accounts
{
    ...
    public class OrdersServiceSpecs : WithSubject<OrdersService>
    {
        ...
        class when_placing_a_market_order
        {
            ...
            Because of = () =>
                result = Subject.PlaceMarketOrderAsync(OrderSide.Buy, ProductType.BtcUsd, .01M).Result;
        ...
        class when_placing_a_limit_order
        {
            ...
            Because of = () =>
                result = Subject.PlaceLimitOrderAsync(OrderSide.Buy, ProductType.BtcUsd, .01M, 0.1M).Result;
