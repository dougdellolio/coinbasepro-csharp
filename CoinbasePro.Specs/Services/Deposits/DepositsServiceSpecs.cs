...
namespace CoinbasePro.Specs.Services.Deposits
{
    ...
    public class DepositsServiceSpecs : WithSubject<DepositsService>
    {
        ...
        class when_requesting_a_deposit
        {
            ...
            Because of = () =>
                deposit_response = Subject.DepositFundsAsync("593533d2-ff31-46e0-b22e-ca754147a96a", 10, "USD").Result;
        ...
        class when_requesting_a_coinbase_deposit
        {
            ...
            Because of = () =>
                coinbase_response = Subject.DepositCoinbaseFundsAsync("593533d2-ff31-46e0-b22e-ca754147a96a", 10, "BTC").Result;
